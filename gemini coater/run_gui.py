...
try:
    ...
    print(f"   Location: {coating_simulator.__file__}") # Show where it was found
    ...
    from coating_simulator import gui # Import the subpackage
    ...
    from coating_simulator.gui import app # Import the module
    ...
    from coating_simulator.gui.app import App # Import the class
    ...
    traceback.print_exc() # Print full traceback for the import error
    try:
        root = tk.Tk()
        root.withdraw()
